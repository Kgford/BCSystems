...
class Model(models.Model):   
    ...
    category  = models.CharField("category",max_length=20,null=False,unique=False,default='N/A')  # Modem, Switch, Modem Switch, Controller, SC-90 Upgrades
    band = models.CharField("band",max_length=29,null=False,unique=False,default='N/A')  # L-Band, Ku-Band, C-Band, Ka-Band
    ...
    status = models.CharField("status",max_length=20,null=True,unique=False) 
