...
class Sales_ChargeCodes(models.Model):
    id = models.AutoField(primary_key=True)
...
class Sales_ClassCodes(models.Model):
    id = models.AutoField(primary_key=True)
...
class Sales_ColorCodes(models.Model):
    id = models.AutoField(primary_key=True)
...
class Sales_SizeCodes(models.Model):
    id = models.AutoField(primary_key=True)
...
class Sales_TypeCodes(models.Model):
    id = models.AutoField(primary_key=True)
...
class Sales_CompanyInfo(models.Model):
    id = models.AutoField(primary_key=True)
...
class Sales_Customers(models.Model):
    id = models.AutoField(primary_key=True)
...
class Sales_Expenses(models.Model):
    id = models.AutoField(primary_key=True)
...
class Sales_Images(models.Model):
    id = models.AutoField(primary_key=True)
    InventoryID = models.CharField("inventory id",max_length=255,null=True,unique=False,default='N/A')
...
class Sales_Inventory(models.Model):
    id = models.AutoField(primary_key=True)
...
class Sales_InvoiceID(models.Model):
    id = models.AutoField(primary_key=True)
...
class Sales_Materials(models.Model):
    id = models.AutoField(primary_key=True)
    VendorID = models.CharField("vendor id",max_length=50,null=True,unique=False,default='N/A')
...
class Sales_QuoteID(models.Model):
    id = models.AutoField(primary_key=True)
    InvoiceReference = models.CharField("invoice ref",max_length=50,null=True,unique=False,default='N/A')
    Customer = models.CharField("customer",max_length=50,null=True,unique=False,default='N/A')
    InvoiceDate = models.DateField(null=True)
...
class Sales_SalesTransation(models.Model):
    id = models.AutoField(primary_key=True)
    CustomerID = models.IntegerField(null=True,unique=False)
...
class Sales_Vendors(models.Model):
    id = models.AutoField(primary_key=True)
...
class Sales_ZipCode(models.Model):
    id = models.AutoField(primary_key=True)
