...
class Manuf_ChargeCodes(models.Model):
    id = models.AutoField(primary_key=True)
...
class Manuf_ClassCodes(models.Model):
    id = models.AutoField(primary_key=True)
...
class Manuf_ColorCodes(models.Model):
    id = models.AutoField(primary_key=True)
...
class Manuf_SizeCodes(models.Model):
    id = models.AutoField(primary_key=True)
...
class Manuf_TypeCodes(models.Model):
    id = models.AutoField(primary_key=True)
...
class Manuf_CompanyInfo(models.Model):
    id = models.AutoField(primary_key=True)
...
class Manuf_Customers(models.Model):
    id = models.AutoField(primary_key=True)
...
class Manuf_Expenses(models.Model):
    id = models.AutoField(primary_key=True)
...
class Manuf_Images(models.Model):
    id = models.AutoField(primary_key=True)
    InventoryID = models.CharField("inventory id",max_length=255,null=True,unique=False,default='N/A')
...
class Manuf_Inventory(models.Model):
    id = models.AutoField(primary_key=True)
...
class Manuf_Invoice(models.Model):
    id = models.AutoField(primary_key=True)
...
class Manuf_InvoiceID(models.Model):
    id = models.AutoField(primary_key=True)
...
class Manuf_Materials(models.Model):
    id = models.AutoField(primary_key=True)
    VendorID = models.CharField("vendor id",max_length=50,null=True,unique=False,default='N/A')
...
class Manuf_Orders(models.Model):
    id = models.AutoField(primary_key=True)
    ...
    Deposit = models.DecimalField("Deposit",max_digits=10, decimal_places=2,null=True,unique=False) 
    Client = models.CharField("Client",max_length=50,null=True,unique=False,default='N/A')
    last_update = models.DateField(null=True)
    backup_index = models.IntegerField(null=True,unique=False)
    
class Manuf_PO(models.Model):
    id = models.AutoField(primary_key=True)
...
class Manuf_Quote(models.Model):
    id = models.AutoField(primary_key=True)
    InvoiceID = models.IntegerField(null=True,unique=False)
    ResourceID = models.IntegerField(null=True,unique=False)
    CustomerID = models.IntegerField(null=True,unique=False)
...
class Manuf_QuoteID(models.Model):
    id = models.AutoField(primary_key=True)
    InvoiceReference = models.CharField("invoice ref",max_length=50,null=True,unique=False,default='N/A')
    Customer = models.CharField("customer",max_length=50,null=True,unique=False,default='N/A')
    InvoiceDate = models.DateField(null=True)
...
class Manuf_SalesTransation(models.Model):
    id = models.AutoField(primary_key=True)
    CustomerID = models.IntegerField(null=True,unique=False)
...
class Manuf_Vendors(models.Model):
    id = models.AutoField(primary_key=True)
...
class Manuf_ZipCode(models.Model):
    id = models.AutoField(primary_key=True)
