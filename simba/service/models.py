...
class Service_ChargeCodes(models.Model):
...
class Service_ClassCodes(models.Model):
    id = models.AutoField(primary_key=True)
...
class Service_CompanyInfo(models.Model):
    id = models.AutoField(primary_key=True)
...
class Service_Customers(models.Model):
    id = models.AutoField(primary_key=True)
...
class Service_Expenses(models.Model):
    id = models.AutoField(primary_key=True)
...
class Service_Inventory(models.Model):
    id = models.AutoField(primary_key=True)
...
class Service_InvoiceID(models.Model):
    id = models.AutoField(primary_key=True)
...
class Service_Quote(models.Model):
    id = models.AutoField(primary_key=True)
    InvoiceID = models.IntegerField(null=True,unique=False)
    ResourceID = models.IntegerField(null=True,unique=False)
    CustomerID = models.IntegerField(null=True,unique=False)
...
class Service_QuoteID(models.Model):
    id = models.AutoField(primary_key=True)
    InvoiceReference = models.CharField("invoice ref",max_length=50,null=True,unique=False,default='N/A')
    Customer = models.CharField("customer",max_length=50,null=True,unique=False,default='N/A')
    InvoiceDate = models.DateField(null=True)
...
class Service_Vendors(models.Model):
    id = models.AutoField(primary_key=True)
...
class Service_ZipCode(models.Model):
    id = models.AutoField(primary_key=True)
